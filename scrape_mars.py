...
def scrape():
    ...
    # Scrape headlines from the NASA Mars News site
    ...
    # Scrape feautured image from the JPL website
    ...
    try:
        ...
        image_path = 'https://www.jpl.nasa.gov/spaceimages/images/mediumsize/PIA17761_ip.jpg'
        mars_data["feature_image_src"] = image_path
        
    # Scrape the latest tweet from the mars weather report twitter
    ...
    # Visit space facts url and scrape the mars facts table
